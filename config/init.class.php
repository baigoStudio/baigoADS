...
class CLASS_INIT {
    ...
    function __construct() {
        ...
        $this->arr_config = array(
            ...
            "BG_PATH_ADVERT"         => array("BG_PATH_ROOT . BG_NAME_ADVERT . \"/\"", "const"),
        ...
        $this->arr_dbconfig = array(
            ...
            "BG_DB_NAME"     => array("baigo_ads", "str"),
            "BG_DB_USER"     => array("baigo_ads", "str"),
            "BG_DB_PASS"     => array("baigo_ads", "str"),
            "BG_DB_CHARSET"  => array("utf8", "str"),
            "BG_DB_TABLE"    => array("ads_", "str"),
        );
        ...
        $this->arr_sso = array(
            "BG_SSO_URL"    => array("\"http://\" . \$_SERVER[\"SERVER_NAME\"] . \"/sso/api/api.php\"", "const"),
