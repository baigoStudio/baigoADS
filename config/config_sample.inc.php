...
define('BG_NAME_CONTENT', 'content');
define('BG_NAME_PLUGIN', 'plugin');
define('BG_NAME_CACHE', 'cache');
define('BG_NAME_TPL', 'tpl');
define('BG_NAME_ATTACH', 'attach');
...
define('BG_PATH_CONTENT', BG_PATH_ROOT . BG_NAME_CONTENT . DS);
define('BG_PATH_PLUGIN', BG_PATH_CONTENT . BG_NAME_PLUGIN . DS);
define('BG_PATH_CACHE', BG_PATH_CONTENT . BG_NAME_CACHE . DS);
define('BG_PATH_TPL', BG_PATH_CONTENT . BG_NAME_TPL . DS);
