            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="form-text"><?php echo $adminRow['admin_name']; ?></div>
                    </div>

                    <div class="form-group">
                        <label><?php echo $lang->get('Nickname'); ?></label>
                        <div class="form-text"><?php echo $adminRow['admin_nick']; ?></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-text"><?php echo $adminRow['admin_note']; ?></div>
                    </div>
                </div>
            ...
            <div class="card bg-light">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="form-text"><?php echo $adminRow['admin_id']; ?></div>
                    </div>
