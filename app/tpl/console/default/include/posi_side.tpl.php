      ...
      <div class="card-body">
        <?php if ($posiRow['posi_id'] > 0) { ?>
          <div class="form-group">
            ...
            <div class="form-text font-weight-bolder"><?php echo $posiRow['posi_id']; ?></div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-text font-weight-bolder"><?php echo $posiRow['posi_name']; ?></div>
          </div>

          <div class="form-group">
            <label class="text-muted font-weight-light"><?php echo $lang->get('Ad count'); ?></label>
            <div class="form-text font-weight-bolder"><?php echo $posiRow['posi_count']; ?></div>
          </div>
        <?php }

        if (!empty($scriptConfig['name'])) { ?>
          <div class="form-group">
            <label class="text-muted font-weight-light"><?php echo $lang->get('Ad script name'); ?></label>
            <div class="form-text font-weight-bolder">
