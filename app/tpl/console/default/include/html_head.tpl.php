...
<head>
  ...
  if (isset($cfg['baigoValidate'])) { ?>
    <link href="{:DIR_STATIC}lib/baigoValidate/3.1.1/baigoValidate.css" type="text/css" rel="stylesheet">
  <?php }

  if (isset($cfg['baigoSubmit'])) { ?>
    <link href="{:DIR_STATIC}lib/baigoSubmit/2.1.4/baigoSubmit.css" type="text/css" rel="stylesheet">
  <?php }

  if (isset($cfg['baigoClear'])) { ?>
    <link href="{:DIR_STATIC}lib/baigoClear/2.0.1/baigoClear.css" type="text/css" rel="stylesheet">
  <?php }

  if (isset($cfg['prism'])) { ?>
    <link href="{:DIR_STATIC}lib/prism/prism.css" type="text/css" rel="stylesheet">
  <?php } ?>

  <link href="{:DIR_STATIC}css/common.css" type="text/css" rel="stylesheet">
  <link href="{:DIR_STATIC}ads/css/console.css" type="text/css" rel="stylesheet">
