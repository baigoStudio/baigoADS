        ...
        <?php if (!empty($yearRows)) { ?>
          <div class="dropdown-menu">
            <?php foreach ($yearRows as $key=>$value) { ?>
              <a class="dropdown-item <?php if ($search['year'] == $value['stat_year']) { ?>active<?php } ?>" href="<?php echo $route_console; ?>stat_posi/month/id/<?php echo $posiRow['posi_id']; ?>/year/<?php echo $value['stat_year']; ?>/">
