			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="form-group">
						...
						<p class="form-control-static static_input">{$tplData.advertRow.advert_name}</p>
					</div>
					...
					{else}
						<div class="form-group">
							...
							<p class="form-control-static static_input">{$tplData.advertRow.advert_content}</p>
						</div>
					{/if}

					<div class="form-group">
						<label class="control-label static_label">{$lang.label.advertBegin}</label>
						<p class="form-control-static static_input">{$tplData.advertRow.advert_begin|date_format:"{$smarty.const.BG_SITE_DATE} {$smarty.const.BG_SITE_TIMESHORT}"}</p>
					</div>

					<div class="form-group">
						<label class="control-label static_label">{$lang.label.note}</label>
						<p class="form-control-static static_input">{$tplData.advertRow.advert_note}</p>
					</div>
		...
		<div class="col-md-3">
			<div class="well">
				<div class="form-group">
					...
					<p class="form-control-static static_input">{$tplData.advertRow.advert_id}</p>
				</div>
				...
				<div class="form-group">
					...
					<p class="form-control-static static_input">{$type.put[$tplData.advertRow.advert_put_type]}</p>
				</div>

				{if $tplData.advertRow.advert_put_type == "date"}
					<div class="form-group">
						<label class="control-label static_label">{$lang.label.advertPutDate}</label>
						<p class="form-control-static static_input">{$tplData.advertRow.advert_put_opt|date_format:"{$smarty.const.BG_SITE_DATE} {$smarty.const.BG_SITE_TIMESHORT}"}</p>
					</div>
				{else if $tplData.advertRow.advert_put_type == "show"}
					<div class="form-group">
						<label class="control-label static_label">{$lang.label.advertPutShow}</label>
						<p class="form-control-static static_input">{$tplData.advertRow.advert_put_opt}</p>
					</div>
				{else}
					<div class="form-group">
				...
				<div class="form-group">
					...
					<p class="form-control-static static_input">{$tplData.advertRow.advert_percent * 10}%</p>
				</div>
