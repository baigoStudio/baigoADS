...
&lt;html lang=&quot;{$config.lang|truncate:2:''}&quot;&gt;
    &lt;head&gt;
        ...
        &lt;link href=&quot;{$smarty.const.BG_SITE_URL}{$smarty.const.BG_URL_ADVERT}{$tplData.posiRow.posi_script}/style.css&quot; type=&quot;text/css&quot; rel=&quot;stylesheet&quot;&gt;
...
{/if}
        ...
        &lt;script src=&quot;{$smarty.const.BG_SITE_URL}{$smarty.const.BG_URL_ADVERT}{$tplData.posiRow.posi_script}/script.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;
        ...
        <div class="col-md-3">
            <div class="well">
                ...
                <div class="form-group">
                    ...
                    <p class="form-control-static">{$tplData.posiRow.posi_name}</p>
                </div>

                <div class="form-group">
                    <label class="control-label static_label">{$lang.label.posiCount}</label>
                    <p class="form-control-static">{$tplData.posiRow.posi_count}</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <p class="form-control-static">{$tplData.posiRow.posi_note}</p>
                </div>
