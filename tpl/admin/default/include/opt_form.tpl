		...
		<div class="form-group">
			<div id="group_{$key}">
				...
				{if $value.type == "select"}
					<select name="opt[{$cfg.sub_active}][{$key}]" id="opt_{$cfg.sub_active}_{$key}" class="validate form-control">
				...
				{else}
					<input type="text" value="{$_this_value}" name="opt[{$cfg.sub_active}][{$key}]" id="opt_{$cfg.sub_active}_{$key}" class="validate form-control">
				{/if}
