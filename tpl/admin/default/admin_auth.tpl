                                    ...
                                    <dd>
                                        ...
                                        {foreach $value_m.allow as $key_s=>$value_s}
                                            <label for="allow_{$key_m}_{$key_s}" class="checkbox-inline">
                                                <input type="checkbox" name="admin_allow[{$key_m}][{$key_s}]" value="1" id="allow_{$key_m}_{$key_s}" data-parent="allow_{$key_m}">
                                                {$value_s}
                                            </label>
                                        {/foreach}
                                    </dd>
                                ...
                                <dd>
                                    ...
                                    {foreach $opt as $key_s=>$value_s}
                                        <label for="allow_opt_{$key_s}" class="checkbox-inline">
                                            <input type="checkbox" name="admin_allow[opt][{$key_s}]" value="1" id="allow_opt_{$key_s}" data-parent="allow_opt">
                                            {$value_s.title}
                                        </label>
                                    {/foreach}
                                </dd>
                            ...
                            {foreach $status.admin as $key=>$value}
                                <div class="radio_baigo">
                                    <label for="admin_status_{$key}">
                                        <input type="radio" name="admin_status" id="admin_status_{$key}" {if $tplData.adminRow.admin_status == $key}checked{/if} value="{$key}" data-validate="admin_status">
                                        {$value}
                                    </label>
                                </div>
                            {/foreach}
