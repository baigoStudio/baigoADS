                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div id="group_admin_nick">
                                ...
                                <input type="text" name="admin_nick" id="admin_nick" value="{if $tplData.adminLogged.admin_nick}{$tplData.adminLogged.admin_nick}{else}{$tplData.ssoRow.user_nick}{/if}" class="form-control">
                            </div>
                        </div>
...
{include "{$smarty.const.BG_PATH_TPL}admin/default/include/admin_foot.tpl" cfg=$cfg}
    ...
    var opts_validator_form = {
        admin_mail: {
            ...
            msg: { selector: "#msg_admin_mail", too_long: "{$alert.x020208}", format_err: "{$alert.x020209}" }
        },
        admin_nick: {
            len: { min: 0, max: 30 },
