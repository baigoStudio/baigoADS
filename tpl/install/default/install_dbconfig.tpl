...
{include "{$smarty.const.BG_PATH_TPL}install/default/include/install_head.tpl" cfg=$cfg}
	...
	<form name="install_form_dbconfig" id="install_form_dbconfig">
		...
		<div class="form-group">
			...
			<input type="text" name="db_name" id="db_name" class="validate form-control input-lg" value="{if $smarty.const.BG_DB_NAME}{$smarty.const.BG_DB_NAME}{else}baigo_adms{/if}">
		</div>

		<div class="form-group">
			<label class="control-label">{$lang.label.dbUser}<span id="msg_db_user">*</span></label>
			<input type="text" name="db_user" id="db_user" class="validate form-control input-lg" value="{if $smarty.const.BG_DB_USER}{$smarty.const.BG_DB_USER}{else}baigo_adms{/if}">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" name="db_table" id="db_table" class="validate form-control input-lg" value="{if $smarty.const.BG_DB_TABLE}{$smarty.const.BG_DB_TABLE}{else}adms_{/if}">
		</div>
