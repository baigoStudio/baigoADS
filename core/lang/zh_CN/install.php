...
return array(
    "x030403" => "<h3>如需重新安装，请执行如下步骤：</h3>
        <ol>
            <li>删除 " . BG_PATH_CONFIG . "/is_install.php 文件</li>
    ...
    "x030420" => "<h3>如继续安装，请执行如下步骤：</h3>
        <ol>
            <li>将 baigo SSO 上传至 " . BG_PATH_SSO . "</li>
            <li><a href=\"" . BG_URL_INSTALL . "ctl.php?mod=install&act_get=ssoAuto\">重新运行本程序</a></li>
        </ol>",

    "x030421" => "<h3>如继续安装，请执行如下步骤：</h3>
        <ol>
            <li>将 baigo SSO 上传至 " . BG_PATH_SSO . "</li>
            <li><a href=\"" . BG_URL_INSTALL . "ctl.php?mod=install&act_get=ssoAdmin\">重新运行本程序</a></li>
        </ol>",
);
