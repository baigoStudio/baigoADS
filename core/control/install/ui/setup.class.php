...
class CONTROL_INSTALL_UI_SETUP {
    ...
    private function table_media() {
        ...
        $_arr_mediaCreateTable  = $_mdl_media->mdl_create_table();

        $this->tplData['db_rcode']['media_create_table'] = array(
            'rcode'   => $_arr_mediaCreateTable['rcode'],
            'status'  => substr($_arr_mediaCreateTable['rcode'], 0, 1),
        );
    }
