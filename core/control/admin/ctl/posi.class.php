...
class CONTROL_POSI {
	...
	function ctl_list() {
		...
		$_num_posiCount   = $this->mdl_posi->mdl_count($_str_key, $_str_status);
		$_arr_page        = fn_page($_num_posiCount); //取得分页数据
		$_str_query       = http_build_query($_arr_search);
		$_arr_posiRows    = $this->mdl_posi->mdl_list(BG_DEFAULT_PERPAGE, $_arr_page["except"], $_str_key, $_str_status);
