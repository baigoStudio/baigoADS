...
class CONTROL_CONSOLE_UI_ADVERT {
    ...
    */
    function ctrl_show() {
        ...
        if ($_arr_posiRow['posi_type'] == 'attach' && $_arr_advertRow['advert_attach_id'] > 0) {
            $_arr_advertRow['attachRow'] = $this->mdl_attach->mdl_read($_arr_advertRow['advert_attach_id']);
        }
    ...
    function ctrl_form() {
        ...
        if ($_num_advertId > 0) {
            ...
            if ($_arr_posiRow['posi_type'] == 'attach' && $_arr_advertRow['advert_attach_id'] > 0) {
                ...
                $_arr_advertRow['attachRow'] = $_arr_attachRow;
            }
        } else {
