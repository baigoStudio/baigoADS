...
<?php include($cfg['pathInclude'] . 'setup_head.php'); ?>
    ...
    <form name="setup_form_admin" id="setup_form_admin">
        ...
        <p><a href="<?php BG_URL_INSTALL; ?>index.php?mod=setup&act=auth" class="btn btn-info"><?php echo $this->lang['mod']['href']['auth']; ?></a></p>
...
<?php include($cfg['pathInclude'] . 'install_foot.php'); ?>
    ...
    var opts_validator_form = {
        admin_name: {
            ...
            ajax: { url: "<?php BG_URL_INSTALL; ?>request.php?mod=setup&act=chkname", key: "admin_name", type: "str" }
        },
        admin_pass: {
            len: { min: 1, max: 0 },
