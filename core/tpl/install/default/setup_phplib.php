<?php $cfg = array(
    'title'         => $this->lang['mod']['page']['setup'] . ' &raquo; ' . $this->lang['mod']['page']['phplib'],
        ...
        <?php } else { ?>
            <div class="btn-toolbar justify-content-between">
                <div class="btn-group">
                    ...
                    <a href="<?php echo BG_URL_INSTALL; ?>index.php?m=setup&a=dbconfig" class="btn btn-secondary"><?php echo $this->lang['mod']['btn']['skip']; ?></a>
                </div>
                <div class="btn-group">
                    <a class="btn btn-primary" href="<?php echo BG_URL_INSTALL; ?>index.php?m=setup&a=dbconfig"><?php echo $this->lang['mod']['btn']['next']; ?></a>
                </div>
            </div>
        <?php } ?>
    </div>
