...
<?php include($cfg['pathInclude'] . 'setup_head.php'); ?>
    ...
    <form name="setup_form" id="setup_form">
        ...
        <?php if ($GLOBALS['route']['bg_act'] == "sso") { ?>
            ...
            <p><a href="<?php BG_URL_INSTALL; ?>index.php?mod=setup&act=ssoAuto" class="btn btn-info"><?php echo $this->lang['mod']['href']['ssoAuto']; ?></a></p>
        <?php }
...
<?php include($cfg['pathInclude'] . 'install_foot.php'); ?>
    ...
    var opts_submit_form = {
        ...
        jump: {
            url: "<?php BG_URL_INSTALL; ?>index.php?mod=setup&act=<?php echo $this->tplData['setup_step']['next']; ?>",
