...
<?php include($cfg['pathInclude'] . 'upgrade_head.php'); ?>
    ...
    <form name="upgrade_form_auth" id="upgrade_form_auth">
        ...
        <p><a href="<?php BG_URL_INSTALL; ?>index.php?mod=upgrade&act=admin" class="btn btn-info"><?php echo $this->lang['mod']['href']['admin']; ?></a></p>
...
<?php include($cfg['pathInclude'] . 'install_foot.php'); ?>
    ...
    var opts_validator_form = {
        admin_name: {
            ...
            ajax: { url: "<?php BG_URL_INSTALL; ?>request.php?mod=upgrade&act=chkauth", key: "admin_name", type: "str" }
        }
    };
