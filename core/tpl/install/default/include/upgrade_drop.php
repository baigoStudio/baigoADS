                    <div class="btn-group dropup">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item<?php if ($GLOBALS['route']['bg_act'] == 'phplib') { ?> active<?php } ?>" href="<?php echo BG_URL_INSTALL; ?>index.php?m=upgrade&a=phplib"><?php echo $this->lang['mod']['page']['phplib']; ?></a>
