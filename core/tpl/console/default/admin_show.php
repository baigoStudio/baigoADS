            ...
            <div class="card mb-3 mb-lg-0">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-text"><?php if (fn_isEmpty($this->tplData['adminRow']['admin_nick'])) { echo $this->tplData['adminRow']['ssoRow']['user_nick']; } else { echo $this->tplData['adminRow']['admin_nick']; } ?></div>
                    </div>
