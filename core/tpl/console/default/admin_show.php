            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-static"><?php if (fn_isEmpty($this->tplData['adminRow']['admin_nick'])) { echo $this->tplData['adminRow']['ssoRow']['user_nick']; } else { echo $this->tplData['adminRow']['admin_nick']; } ?></div>
                    </div>
