        ...
        <div class="tab-pane active" id="mail">
            <form name="forgot_mail" id="forgot_mail">
                ...
                <?php } else { ?>
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <a href="javascript:void(0);" class="captchaBtn">
                                    <img src="<?php echo BG_URL_CONSOLE; ?>index.php?m=captcha&a=make" class="captchaImg" alt="<?php echo $this->lang['mod']['btn']['captcha']; ?>">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="javascript:void(0);" class="captchaBtn">
                    ...
                    <div class="bg-validator-box mt-3 bg-validator-box-mail"></div>
        ...
        <div class="tab-pane" id="qa">
            <form name="forgot_qa" id="forgot_qa">
                ...
                <?php } else {
                    ...
                    <div class="bg-validator-box mt-3 bg-validator-box-qa"></div>
...
<?php include($cfg['pathInclude'] . 'login_foot.php'); ?>
    ...
    var opts_validator_mail = {
        captcha_mail: {
            ...
            ajax: { url: "<?php echo BG_URL_CONSOLE; ?>index.php?m=captcha&c=request&a=chk", key: "captcha", type: "str" }
        }
    };

    var options_validator_mail = {
        msg_global:{
            selector: {
                parent: "#bg-validator-box-mail"
            },
            msg: "<?php echo $this->lang['common']['label']['errInput']; ?>"
        }
    };

    var options_validator_qa = {
        msg_global:{
            selector: {
                parent: "#bg-validator-box-qa"
            },
            msg: "<?php echo $this->lang['common']['label']['errInput']; ?>"
        }
    };
    ...
    $(document).ready(function(){
        var obj_validator_mail  = $("#forgot_mail").baigoValidator(opts_validator_mail, options_validator_mail);
        ...
        var obj_validator_qa    = $("#forgot_qa").baigoValidator(opts_validator_qa, options_validator_qa);
