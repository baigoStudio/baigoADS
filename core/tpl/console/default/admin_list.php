<?php $cfg = array(
    ...
    'str_url'        => BG_URL_CONSOLE . "index.php?m=admin&" . $this->tplData['query'],
);
    ...
    <div class="clearfix mb-3">
        <div class="float-left">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a href="<?php echo BG_URL_CONSOLE; ?>index.php?m=admin&a=auth" class="nav-link">
                        <span class="oi oi-circle-check"></span>
                        <?php echo $this->lang['mod']['href']['auth']; ?>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo BG_URL_HELP; ?>index.php?m=console&a=admin" class="nav-link" target="_blank">
            ...
            <table class="table table-striped table-hover border">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $this->lang['mod']['label']['nick']; ?> / <?php echo $this->lang['mod']['label']['note']; ?></th>
