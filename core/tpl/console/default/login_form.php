...
include($cfg['pathInclude'] . 'login_head.php'); ?>
    ...
    <form method="post" id="login_form">
        ...
        <div class="form-group">
            <button type="button" class="btn btn-primary btn-lg btn-block bg-submit"><?php echo $this->lang['mod']['btn']['login']; ?></button>
        </div>
...
<?php include($cfg['pathInclude'] . 'login_foot.php'); ?>
    ...
    $(document).ready(function(){
        $("#admin_name").focus();
        var obj_validate_form  = $("#login_form").baigoValidator(opts_validator_form, options_validator_form);
