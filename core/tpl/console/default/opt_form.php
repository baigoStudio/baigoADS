    ...
    <form name="opt_form" id="opt_form">
        ...
        <div class="card">
            <div class="card-body">
                ...
                $arr_form = opt_form_process($this->opt[$this->tplData['act']]['list'], $this->lang['opt'][$this->tplData['act']]['list'], $_tplRows, $_timezoneRows, $_timezoneLang, $_timezoneType, $this->lang['mod'], $this->lang['rcode']); ?>
...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    $(document).ready(function(){
        var obj_validate_form = $("#opt_form").baigoValidator(opts_validator_form, options_validator_form);
