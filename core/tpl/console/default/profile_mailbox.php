...
$cfg = array(
    ...
    'str_url'        => BG_URL_CONSOLE . "index.php?m=profile&a=pass"
);
                ...
                <div class="card mb-3 mb-lg-0">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" readonly value="<?php echo $this->tplData['ssoRow']['user_mail']; ?>">
                        </div>
...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_form = {
        ...
        admin_mail_new: {
            ...
            ajax: { url: "<?php echo BG_URL_CONSOLE; ?>index.php?m=admin&c=request&a=chkmail", key: "admin_mail", type: "str" }
        }
    };
