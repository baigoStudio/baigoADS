                ...
                var opts_validator_form = {
                    db_host: {
                        ...
                        msg: { selector: "#msg_db_host", too_short: "<?php echo $this->lang['rcode']['x060204']; ?>", too_long: "<?php echo $this->lang['rcode']['x060205']; ?>" }
                    },
                    db_name: {
                        len: { min: 1, max: 900 },
                        validate: { type: "str", format: "text", group: "#group_db_name" },
                        msg: { selector: "#msg_db_name", too_short: "<?php echo $this->lang['rcode']['x060206']; ?>", too_long: "<?php echo $this->lang['rcode']['x060207']; ?>" }
                    },
                    db_port: {
                        len: { min: 1, max: 900 },
                        validate: { type: "str", format: "text", group: "#group_db_port" },
                        msg: { selector: "#msg_db_port", too_short: "<?php echo $this->lang['rcode']['x060208']; ?>", too_long: "<?php echo $this->lang['rcode']['x060209']; ?>" }
                    },
                    db_user: {
                        len: { min: 1, max: 900 },
                        validate: { type: "str", format: "text", group: "#group_db_user" },
                        msg: { selector: "#msg_db_user", too_short: "<?php echo $this->lang['rcode']['x060210']; ?>", too_long: "<?php echo $this->lang['rcode']['x060211']; ?>" }
                    },
                    db_pass: {
                        len: { min: 1, max: 900 },
                        validate: { type: "str", format: "text", group: "#group_db_pass" },
                        msg: { selector: "#msg_db_pass", too_short: "<?php echo $this->lang['rcode']['x060212']; ?>", too_long: "<?php echo $this->lang['rcode']['x060213']; ?>" }
                    },
                    db_charset: {
                        len: { min: 1, max: 900 },
                        validate: { type: "str", format: "text", group: "#group_db_charset" },
                        msg: { selector: "#msg_db_charset", too_short: "<?php echo $this->lang['rcode']['x060214']; ?>", too_long: "<?php echo $this->lang['rcode']['x060215']; ?>" }
                    },
                    db_table: {
                        len: { min: 1, max: 900 },
                        validate: { type: "str", format: "text", group: "#group_db_table" },
                        msg: { selector: "#msg_db_table", too_short: "<?php echo $this->lang['rcode']['x060216']; ?>", too_long: "<?php echo $this->lang['rcode']['x060217']; ?>" }
                    }
                };
                </script>