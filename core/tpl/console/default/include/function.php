<?php function opt_form_process($arr_formList, $lang_opt, $tplRows = array(), $timezoneRows = array(), $timezoneLang = array(), $timezoneType = '', $lang_label = array(), $rcode = array()) {
    ...
    if ($GLOBALS['route']['bg_act'] == 'base') { ?>
        ...
        $_str_json .= 'opts_validator_form.opt_base_BG_SITE_TPL = {
            ...
            msg: { selector: "#msg_base_BG_SITE_TPL", too_few: "' . $rcode['x060201'] . $lang_label['tpl'] . '" }
        };
        opts_validator_form.opt_base_BG_SITE_TIMEZONE = {
            len: { min: 1, max: 0 },
            validate: { type: "select", group: "#group_base_BG_SITE_TIMEZONE" },
            msg: { selector: "#msg_base_BG_SITE_TIMEZONE", too_few: "' . $rcode['x060201'] . $lang_label['timezone'] . '" }
        };';
    }
...
function advert_status_process($arr_advertRow, $status_advert) {
    ...
    ?><span class="label label-<?php echo $_str_css; ?> bg-label"><?php echo $_str_status; ?></span><?php
}
...
function posi_status_process($str_status, $status_posi) {
    ...
    ?><span class="label label-<?php echo $_str_css; ?> bg-label"><?php echo $status_posi[$str_status]; ?></span><?php
}
