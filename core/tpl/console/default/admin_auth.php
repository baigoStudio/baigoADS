                ...
                <div class="card mb-3 mb-lg-0">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <?php allow_list($this->consoleMod, $this->lang['consoleMod'], $this->opt, $this->lang['opt'], $this->lang['mod']['label'], $this->lang['common']['page']); ?>
                            ...
                            <?php foreach ($this->tplData['status'] as $key=>$value) { ?>
                                <div class="form-check">
                                    <label for="admin_status_<?php echo $value; ?>" class="form-check-label">
                                        <input type="radio" name="admin_status" id="admin_status_<?php echo $value; ?>" <?php if ($this->tplData['adminRow']['admin_status'] == $value) { ?>checked<?php } ?> value="<?php echo $value; ?>" data-validate="admin_status" class="form-check-input">
...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_form = {
        ...
        admin_note: {
            len: { min: 0, max: 30 },
            validate: { type: "str", format: "text" },
            msg: { too_long: "<?php echo $this->lang['rcode']['x010207']; ?>" }
        },
        admin_type: {
            len: { min: 1, max: 0 },
            validate: { selector: "[name='admin_type']", type: "radio" },
            msg: { too_few: "<?php echo $this->lang['rcode']['x020218']; ?>" }
        },
        admin_status: {
            len: { min: 1, max: 0 },
            validate: { selector: "[name='admin_status']", type: "radio" },
            msg: { too_few: "<?php echo $this->lang['rcode']['x010208']; ?>" }
        }
    };
