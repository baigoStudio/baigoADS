<?php $cfg = array(
    'title'          => $this->lang['consoleMod']['admin']['main']['title'] . ' &raquo; ' . $this->lang['mod']['page']['auth'],
    'menu_active'    => "admin",
    'sub_active'     => "auth",
    'baigoCheckall'  => 'true',
    'baigoValidator' => 'true',
                            ...
                            <?php foreach ($this->tplData['status'] as $key=>$value) { ?>
                                <div class="bg-radio">
                                    <label for="admin_status_<?php echo $value; ?>">
                                        <input type="radio" name="admin_status" id="admin_status_<?php echo $value; ?>" <?php if ($this->tplData['adminRow']['admin_status'] == $value) { ?>checked<?php } ?> value="<?php echo $value; ?>" data-validate="admin_status">
