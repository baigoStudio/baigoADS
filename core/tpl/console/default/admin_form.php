                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div id="group_admin_mail">
                                <label class="control-label"><?php echo $this->lang['mod']['label']['mail']; ?><span id="msg_admin_mail"></span></label>
                        ...
                        <?php foreach ($this->profile as $key=>$value) { ?>
                            <div class="bg-checkbox">
                                <label for="admin_allow_profile_<?php echo $key; ?>">
                                    <input type="checkbox" name="admin_allow_profile[<?php echo $key; ?>]" id="admin_allow_profile_<?php echo $key; ?>" value="1" <?php if (isset($this->tplData['adminRow']['admin_allow_profile'][$key]) && $this->tplData['adminRow']['admin_allow_profile'][$key] == 1) { ?>checked<?php } ?>>
...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_form = {
        ...
        admin_mail: {
            ...
            msg: { selector: "#msg_admin_mail", too_long: "<?php echo $this->lang['rcode']['x010207']; ?>", format_err: "<?php echo $this->lang['rcode']['x010208']; ?>" }
        },
        admin_nick: {
            len: { min: 0, max: 30 },
            validate: { type: "str", format: "text", group: "#group_admin_nick" },
            msg: { selector: "#msg_admin_nick", too_long: "<?php echo $this->lang['rcode']['x020212']; ?>" }
        },
        admin_note: {
            len: { min: 0, max: 30 },
            validate: { type: "str", format: "text", group: "#group_admin_note" },
            msg: { selector: "#msg_admin_note", too_long: "<?php echo $this->lang['rcode']['x010207']; ?>" }
        },
        admin_type: {
            len: { min: 1, max: 0 },
            validate: { selector: "[name='admin_type']", type: "radio", group: "#group_admin_type" },
            msg: { selector: "#msg_admin_status", too_few: "<?php echo $this->lang['rcode']['x020218']; ?>" }
        },
        admin_status: {
            len: { min: 1, max: 0 },
            validate: { selector: "[name='admin_status']", type: "radio", group: "#group_admin_status" },
            msg: { selector: "#msg_admin_status", too_few: "<?php echo $this->lang['rcode']['x010208']; ?>" }
        }
    };
