...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_form = {
        ...
        admin_pass_new: {
            ...
            msg: { selector: "#msg_admin_pass_new", too_short: "<?php echo $this->lang['rcode']['x020213']; ?>" }
        },
        admin_pass_confirm: {
            len: { min: 1, max: 0 },
            validate: { type: "confirm", target: "#admin_pass_new", group: "#group_admin_pass_confirm" },
            msg: { selector: "#msg_admin_pass_confirm", too_short: "<?php echo $this->lang['rcode']['x010225']; ?>", not_match: "<?php echo $this->lang['rcode']['x010225']; ?>" }
        }
    };
