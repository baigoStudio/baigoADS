...
class MODEL_ADMIN {
    ...
    function mdl_read($num_adminId) {
        ...
        if (isset($_arr_adminRow['admin_prefer'])) {
            $_arr_adminRow['admin_prefer']    = fn_jsonDecode($_arr_adminRow['admin_prefer'], 'no'); //json解码
        } else {
    ...
    function input_submit() {
        ...
        $this->adminInput['admin_allow_profile'] = fn_jsonEncode(fn_post('admin_allow_profile'), 'no');
