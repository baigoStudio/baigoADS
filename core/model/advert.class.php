...
class MODEL_ADVERT {
    ...
    public $arr_putType = array('date', 'show', 'hit', 'none', 'subs');
    ...
    function mdl_read($str_advert, $str_readBy = 'advert_id', $num_notId = 0) {
        ...
        $_arr_advertRow['advert_href']    = BG_SITE_URL . BG_URL_ADVERT . 'index.php?mod=advert&act=url&advert_id=' . $_arr_advertRow['advert_id'];
    ...
    function mdl_listPub($num_posi, $str_type = '') {
        ...
        foreach ($_arr_advertRows as $_key=>$_value) {
            $_arr_advertRows[$_key]['advert_href']    = BG_SITE_URL . BG_URL_ADVERT . 'index.php?mod=advert&act=url&advert_id=' . $_value['advert_id'];
        }
    ...
    function input_submit() {
        ...
        $_arr_advertName = fn_validate(fn_post('advert_name'), 1, 300);
        ...
        $_arr_advertPosiId = fn_validate(fn_post('advert_posi_id'), 1, 0);
        ...
        $_arr_advertPutType = fn_validate(fn_post('advert_put_type'), 1, 0);
        ...
        $_arr_advertPutOpts = fn_validate(fn_post('advert_put_opt'), $_num_min, 0, 'str', $_str_format);
        ...
        $_arr_advertUrl = fn_validate(fn_post('advert_url'), 1, 3000);
        ...
        $_arr_advertNote = fn_validate(fn_post('advert_note'), 0, 30);
        ...
        $_arr_advertStatus = fn_validate(fn_post('advert_status'), 1, 0);
        ...
        $_arr_advertPercent = fn_validate(fn_post('advert_percent'), 1, 10, 'digit', 'int');
        ...
        $_arr_advertBegin = fn_validate(fn_post('advert_begin'), 1, 0, 'str', 'datetime');
