...
class Reg extends User_Base {
  ...
  private function nameChkProcess($str_userName) {
    ...
    if (isset($_arr_configReg['bad_name']) && Func::notEmpty($_arr_configReg['bad_name'])) {
  ...
  private function mailChkProcess($str_userMail) {
    ...
    if (isset($_arr_configReg['acc_mail']) && Func::notEmpty($_arr_configReg['acc_mail'])) {
    ...
    } else if (isset($_arr_configReg['bad_mail']) && Func::notEmpty($_arr_configReg['bad_mail'])) {
